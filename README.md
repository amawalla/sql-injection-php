...
Note: the XAMPP/WAMP server include all above mentioned technologies
...
* Use PHP frameworks (Yii,Symfony, Laravel, Codeigniter, CakePhp and etc.) in which already used prepared statements.
